...
class PagePersonal(QWidget):
    ...
    def _build_ui(self) -> None:
        ...
        self.table.setHorizontalHeaderLabels(["ID", "Documento", "Nombre", "Teléfono", "Puesto", "Activo"])
    ...
    def _on_nuevo(self) -> None:
        ...
        try:
            ...
            context = f"Tipo documento: {data.personal.tipo_documento.value}\nDocumento: {data.personal.documento}"
