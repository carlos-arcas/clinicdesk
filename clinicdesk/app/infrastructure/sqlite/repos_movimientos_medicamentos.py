...
class MovimientosMedicamentosRepository:
    ...
    def create(self, movimiento: MovimientoMedicamento) -> int:
        ...
        self._con.commit()
        return require_lastrowid(cur, context="MovimientosMedicamentosRepository.create")
    ...
    def get_by_id(self, movimiento_id: int) -> Optional[MovimientoMedicamento]:
        ...
        row = self._con.execute(
            "SELECT * FROM movimientos_medicamentos WHERE id = ? AND activo = 1",
            (movimiento_id,),
        ).fetchone()
    ...
    def _row_to_model(self, row: sqlite3.Row) -> MovimientoMedicamento:
        ...
        return MovimientoMedicamento(
            id=require_row_id(row, context="MovimientosMedicamentosRepository._row_to_model"),
