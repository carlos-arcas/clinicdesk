...
ATRIBUTOS_CITA: tuple[DescriptorAtributoCita, ...] = (
    DescriptorAtributoCita(
        "fecha",
        "citas.lista.col.fecha",
        "citas.lista.tooltip.fecha",
        True,
        SensibilidadAtributo.PUBLICO,
        _fmt_datetime("inicio", "%Y-%m-%d"),
    ),
    DescriptorAtributoCita(
        "hora_inicio",
    ...
    DescriptorAtributoCita(
        "hora_fin",
        "citas.lista.col.hora_fin",
        "citas.lista.tooltip.hora_fin",
        True,
        SensibilidadAtributo.PUBLICO,
        _fmt_datetime("fin", "%H:%M"),
    ),
    DescriptorAtributoCita(
        "paciente",
        "citas.lista.col.paciente",
        "citas.lista.tooltip.paciente",
        True,
    ...
    DescriptorAtributoCita(
        "medico",
        "citas.lista.col.medico",
        "citas.lista.tooltip.medico",
        True,
        SensibilidadAtributo.PERSONAL,
        _fmt_texto("medico"),
    ),
    DescriptorAtributoCita(
        "sala",
        "citas.lista.col.sala",
        "citas.lista.tooltip.sala",
        True,
        SensibilidadAtributo.PUBLICO,
        _fmt_texto("sala"),
    ),
    DescriptorAtributoCita(
        "estado",
        "citas.lista.col.estado",
        "citas.lista.tooltip.estado",
        True,
        SensibilidadAtributo.PUBLICO,
        _fmt_texto("estado"),
    ),
    DescriptorAtributoCita(
        "riesgo_ausencia",
        "citas.lista.col.riesgo",
        "citas.lista.tooltip.riesgo",
        False,
        SensibilidadAtributo.PERSONAL,
        _fmt_texto("riesgo_ausencia"),
    ),
    DescriptorAtributoCita(
        "duracion_estimada",
        "citas.lista.col.duracion_estimada",
        "citas.lista.tooltip.duracion_estimada",
        False,
        SensibilidadAtributo.PUBLICO,
        _fmt_texto("duracion_estimada"),
    ),
    DescriptorAtributoCita(
        "espera_estimada",
        "citas.lista.col.espera_estimada",
        "citas.lista.tooltip.espera_estimada",
        False,
        SensibilidadAtributo.PUBLICO,
        _fmt_texto("espera_estimada"),
    ),
    DescriptorAtributoCita(
        "recordatorio_estado",
        ...
        False,
        SensibilidadAtributo.PUBLICO,
        _fmt_texto("recordatorio_estado"),
    ),
    DescriptorAtributoCita(
        "notas_len",
        "citas.lista.col.notas_len",
        "citas.lista.tooltip.notas_len",
        True,
        SensibilidadAtributo.SENSIBLE,
        _fmt_notas_len("notas_len"),
    ),
    DescriptorAtributoCita(
        "incidencias",
    ...
    DescriptorAtributoCita(
        "cita_id", "citas.lista.col.cita_id", None, False, SensibilidadAtributo.PUBLICO, _fmt_texto("cita_id")
    ),
)
