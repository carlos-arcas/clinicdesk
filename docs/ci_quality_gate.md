...
`rc=20` en `python -m scripts.gate_rapido` mantiene la misma semántica operativa: bloqueo local de entorno/toolchain y validación funcional todavía no ejecutada.
